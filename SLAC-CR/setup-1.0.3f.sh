export INST_DIR=/gpfs/slac/lsst/fs2/u1/devel/ccs/cr/dev/jh_inst/1.0.3f
...
export JHCRCCSUTILSDIR=${INST_DIR}/jh-cr-ccs-utils-1.0.1
export CRJOBSDIR=${INST_DIR}/CR-jobs-1.0.3
export JHDEVTOOLSDIR=${INST_DIR}/jh-dev-tools-0.1.0
export CREOANALYSISJOBSDIR=${INST_DIR}/cr-EO-analysis-jobs-1.0.2
export LCATR_SCHEMA_PATH=${CREOANALYSISJOBSDIR}/schemas:${JHCRCCSUTILSDIR}/schemas:${HARNESSEDJOBSDIR}/schemas:${LCATR_SCHEMA_PATH}
